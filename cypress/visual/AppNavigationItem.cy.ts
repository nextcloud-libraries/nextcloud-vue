...
describe('NcAppNavigationItem', () => {
	describe('With router link', () => {
		...
		it('has tertiary styling on non active route', () => {
			cy.contains('.app-navigation-entry', 'Foo').compareSnapshot(
				'NcAppNavigationItem-tertiary-non-active-route',
			)
		})

		it('has primary styling on active route', () => {
			cy.contains('.app-navigation-entry', 'Home').compareSnapshot(
				'NcAppNavigationItem-primary-on-active-route',
			)
		})

		it('has primary button styling on active route with editing=true', () => {
			cy.contains('.app-navigation-entry', 'Home')
				.find('.app-navigation-entry__actions')
				.click()
			cy.get('.app-navigation-entry--editing').compareSnapshot(
				'NcAppNavigationItem-primary-on-active-route-menu-active',
			)
		})
		...
		it('has tertiary styling on non active entry', () => {
			cy.contains('.app-navigation-entry', 'Bar').compareSnapshot(
				'NcAppNavigationItem-tertiary-non-active-entry',
			)
		})

		it('has primary styling on active entry', () => {
			cy.contains('.app-navigation-entry', 'Back').compareSnapshot(
				'NcAppNavigationItem-primary-on-active-entry',
			)
		})

		it('has primary button styling on active entry with editing=true', () => {
			cy.contains('.app-navigation-entry', 'Back')
				.find('.app-navigation-entry__actions')
				.click()
			cy.get('.app-navigation-entry--editing').compareSnapshot(
				'NcAppNavigationItem-primary-on-active-entry-menu-active',
			)
		})
	})
})
