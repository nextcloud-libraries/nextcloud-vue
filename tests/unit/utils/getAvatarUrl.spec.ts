...
describe('getAvatarUrl', () => {
	...
	it('should return correct relative URL for user avatar', () => {
		...
		expect(getAvatarUrl('alice', '64', false)).toBe(
	...
	it('should return correct relative URL for guest avatar', () => {
		expect(getAvatarUrl('john', 44, true)).toBe(
			'//index.php/avatar/guest/john/44',
		)
		expect(getAvatarUrl('alice', '64', true)).toBe(
			'//index.php/avatar/guest/alice/64',
		)
	})
	...
	it('should return correct relative URL for guest avatar in dark mode', () => {
		...
		expect(getAvatarUrl('john', 44, true)).toBe(
			'//index.php/avatar/guest/john/44/dark',
		)
		expect(getAvatarUrl('alice', '64', true)).toBe(
			'//index.php/avatar/guest/alice/64/dark',
		)
	})
})
