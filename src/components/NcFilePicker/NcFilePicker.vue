...
const props = withDefaults(defineProps<{
	 ...
	 */
	actions?: MenuAction[] | MenuActionGroup[]
	...
	<form
		...
		<NcActions
			...
			<template v-for="group of actions">
				<NcActionCaption
					v-if="(group as MenuActionGroup).caption"
					:key="(group as MenuActionGroup).caption"
					:name="(group as MenuActionGroup).caption" />

				<NcActionButton
					v-for="action of (group as MenuActionGroup).actions ?? [group as MenuAction]"
					:key="action.label"
					closeAfterClick
