...
const props = withDefaults(defineProps<{
	 ...
	 */
	reference: ReferenceWidgetObject | null
	/**
...
const customWidget = useTemplateRef<HTMLDivElement>('customWidget')
const widgetRoot = useTemplateRef<HTMLDivElement>('widgetRoot')
...
const noAccess = computed(() => {
	return props.reference && !props.reference.accessible
})
